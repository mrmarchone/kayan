...
class UserCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => ['required', 'email', 'unique:users,email', auth()->user()->type == 'admin' ? new EmailRule(RestrictedDomain::select('domain')->get()->pluck('domain')->toArray()) : ''],
            'country_id' => 'nullable|numeric|exists:countries,id',
            'section_id' => 'nullable|numeric|exists:sections,id',
            'phone' => ['nullable', 'unique:users,phone', 'min:10', 'max:16', 'regex:/^(?:\+|[^+])[0-9]+$/u'],
