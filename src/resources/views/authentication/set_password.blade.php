                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="{{route('password.set')}}" method="POST">
                                    @method('PATCH')
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="country" name="country">
                                            @foreach($countries as $key => $value)
                                                <option
                                                    {{old('country') == $value ? 'selected' : ''}} value="{{$value}}">{{$key}}</option>
                                            @endforeach
                                        </select>
                                        @error('country')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <select name="section_id" class="form-select" id="sections">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control"
                                                   ...
                                                   aria-label="password_confirmation" aria-describedby="password-addon"
